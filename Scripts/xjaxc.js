/*
http://api-xjaxc.chenglie.tech/game/updateData url script-request-header https://raw.githubusercontent.com/Ariszy/Private-Script/master/Scripts/xjaxc.js
hostname = api-xjaxc.chenglie.tech
*/
const $ = new Env('小鸡爱消除')
const notify = $.isNode() ?require('./sendNotify') : '';
$.idx = ($.idx = ($.getval("xjcount") || "1") - 1) > 0 ? `${$.idx + 1}` : ""; // 账号扩展字符
const xjheadersArr = []
let xjheaders = $.getdata('xjheaders')
//var txbody = `config_id=3`
let num = 1
//var articles =''
